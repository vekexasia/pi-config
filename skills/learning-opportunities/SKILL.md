...
1. `.pi/skills/learning-opportunities/resources/orientation.md` (pi project level)
...
4. `~/.pi/agent/skills/learning-opportunities/resources/orientation.md` (pi user level)
5. `~/.codex/skills/learning-opportunities/resources/orientation.md` (Codex user level)
6. `~/.claude/skills/learning-opportunities/resources/orientation.md` (Claude Code user level)
