 ...
 *
 * Installed from pi example extension.
...
export async function runQuestionnaire(
	...
	params: { questions: Array<{ id: string; label?: string; prompt: string; options: QuestionOption[]; allowOther?: boolean }> },
...
pi.events.emit("herdr:blocked", { active: true, label: "Questionnaire" });
...
export default function questionnaire(pi: ExtensionAPI) {
	pi.registerTool({
		...
		async execute(_toolCallId, params, _signal, _onUpdate, ctx) {
			return runQuestionnaire(pi, ctx, params);
		},
